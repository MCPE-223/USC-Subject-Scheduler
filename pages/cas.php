                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                              ...
                              <li><a href="#"><i class="fa fa-angle-double-right"></i> Create Acadamic Sem</a></li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Create Academic Sem</li>
                    </ol>
                </section>
                ...
                <div  class="form">
                    <form action = "action_cas.php" method="post"> 

                        <p class='contact'> <label>Academic Sem</label></p>
                        <input name="asem"placeholder="Ex.: 1st Year" required="" tabindex="1" type="text">                         
