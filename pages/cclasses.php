        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content">
                        ...
                        <div id="createclasses" class="input-group">
                          <div class="input-group-btn">
                                <a href="logic.php"><button class="btn btn-success" value="Create" type="submit">CREATE CLASSES</button></a>
                          <div class="help-tip">
                                <span>Only create classes after all teachers, subjects and schedules are created! </span>
                          </div>
                        </div>
                </div>      
