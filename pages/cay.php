                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                              ...
                              <li><a href="#"><i class="fa fa-angle-double-right"></i> Create Acadamic Year</a></li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Create Academic Year</li>
                    </ol>
                </section>
                ...
                <div  class="form">
                    <form action = "action_cay.php" method="post"> 

                        <p class='contact'> <label>Academic Year</label></p>
                        <input name="ayear"placeholder="Ex.: 2015-2016" required="" tabindex="1" type="text">                         
