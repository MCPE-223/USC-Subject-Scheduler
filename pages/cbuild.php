    ...
    <header class="header">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <div  class="form">
                    <form action = "action_wcbuild.php" method = "post"> 
                        <p class="contact"><label for="lname">Building Code</label></p> 
                        <input name="bcode" class="bcode" placeholder="Building Code" required="" tabindex="1" type="text"> 

                        <p class="contact"><label for="lname">Building Description</label></p> 
                        <input name="bdesc" class="bdesc" placeholder="Building Description" required="" tabindex="1" type="text"> 
